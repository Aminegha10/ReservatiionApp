...
import { LogInSuccess } from "@/app/services/LoginSlice";
...
const CreatePrestataire = ({ setSignIn, Login }) => {
  //
  ...
  const SubmitData = async (data) => {
    try {
      ...
      localStorage.setItem("prestataireId", prestataireId);
    } catch (err) {
    ...
    <section className=" box-border ">
      <div className="bg-white shadow-lg rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
          <h2 className="font-bold text-3xl text-[#000]">Login</h2>
